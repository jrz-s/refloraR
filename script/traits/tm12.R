  ...
  df |>
    mutate(
      ...
      subestrutura = case_when(
        ...
        estrutura_principal == "flor" & str_detect(txt, "calice")   ~ "calice",
        estrutura_principal == "flor" & str_detect(txt, "textura segmento")   ~ "segmento",
        estrutura_principal == "flor" & str_detect(txt, "sexualidade")   ~ "sexualidade", # add 02.01.2026
