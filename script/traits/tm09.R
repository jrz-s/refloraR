...
## Observações: até o momento tudo está funcionando de boas.
## tarefa para 01/1/2026: cuidar dos processos de aplicação para outros cenários
## ir ajustando até que tudo funcione de forma orgânica.
## o script mais aceito agora é este 'tm09.R' e 'tm08.R'. Os outros são tentativas, depois desconsiderar, se possível.

## REVISAR COM CALMA A SAÍDA NESSE CENÁRIO. DEPOIS VERIFICAR OUTROS CENÁRIOS.
